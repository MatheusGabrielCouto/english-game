...
INSERT OR IGNORE INTO `focus_settings` (`id`, `enabled`, `default_duration_minutes`, `hardcore_mode`, `monitoring_enabled`, `accessibility_disclosure_accepted`, `updated_at`)
...
--> statement-breakpoint
INSERT OR IGNORE INTO `focus_analytics` (`id`, `total_sessions`, `completed_sessions`, `abandoned_sessions`, `total_focus_seconds`, `total_distraction_seconds`, `total_xp_earned`, `total_coins_earned`, `total_sp_earned`, `total_loot_boxes`)
