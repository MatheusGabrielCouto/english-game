...
export const ROUTINE_UI = {
  ...
  reminderTimeHint: 'Formato 24h — só números, ex.: 19:00',
  reminderTimePlaceholder: '00:00',
  reminderTimeAccessibility: 'Horário do lembrete em formato 24 horas',
