...
export const PetFarmMapBuilding = ({ building, badge, onPress }: PetFarmMapBuildingProps) => {
    ...
    <View
      ...
      <PressableScale
        ...
        <Animated.View style={bounceStyle} className="items-center">
          <View
            className={`items-center rounded-2xl border-2 border-amber-100/30 bg-emerald-950/85 shadow-lg ${
