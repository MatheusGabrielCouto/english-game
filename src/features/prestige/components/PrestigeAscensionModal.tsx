...
export const PrestigeAscensionModal = ({ preview }: PrestigeAscensionModalProps) => {
  ...
  return (
    <RNModal visible transparent animationType="fade" onRequestClose={closeAscension}>
      <View className="flex-1 justify-end bg-black/80">
        <View className="max-h-[92%] rounded-t-3xl border border-border bg-surface px-5 pb-8 pt-5">
                  ...
                  <View className="gap-2">
                    <Pressable
                      ...
                      <Text className="text-center text-base font-black text-gold">
                        {isAscending
                          ? PRESTIGE_ASCENSION_COPY.holding
                          : holdProgress > 0
                            ? PRESTIGE_ASCENSION_COPY.holdToConfirm
                            : PRESTIGE_ASCENSION_COPY.holdToConfirm}
                      </Text>
