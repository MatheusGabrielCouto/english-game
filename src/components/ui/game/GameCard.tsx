...
export const GameCard = ({
  ...
  <View
    className={cn('rounded-game border p-5', variantStyles[variant], className)}
    style={[
      glow && Platform.OS === 'android'
        ? { borderWidth: 1.5, borderColor: variant === 'reward' ? 'rgba(251, 191, 36, 0.45)' : 'rgba(139, 92, 246, 0.45)' }
        : glow
          ? {
